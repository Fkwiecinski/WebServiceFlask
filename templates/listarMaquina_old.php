            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th scope="col"><button type="button" class="cadastrar btn btn-success" >Adicionar</button></th>
                    </tr>
                </thead>
                <tbody>
                    <script>
                        ...
                        for(x in meuObj){
                            ...
                            document.write('<td><button class="iStatusVerde btn btn-warning">Editar</button></td>');
                            document.write('<td><button class="confirmar btn btn-danger">Excluir</button></td>');
                            document.write('</tr>');
                        }
                    </script>
                </tbody>
