...
<html lang="pt-br">
        ...
        <nav class="navbar navbar-expand navbar-dark" style="background-color: #215E21;">
            ...
            <div class="" id="conteudoNavbarSuportado">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="/maquinas/listar">Máquinas</a>
                    </li>
                </ul>
            </div>
        </nav>
    ...
    <body>
        <div class="container">
            <br>
            <p>
                <button class="btn btn-primary" data-toggle="collapse" href="#Collapse1" role="button" aria-expanded="false" aria-controls="Collapse1">Filtro <i class="fas fa-search"></i></button>
                <button class="btn btn-success" type="button" data-toggle="collapse" data-target="#Collapse2" aria-expanded="false" aria-controls="Collapse2">Adicionar turno <i class="fas fa-plus"></i></button>
            </p>
            <div class="col">
            ...
            <script>
                ...
                for (x in Maquinas){ 
                    ...
                    document.write('                <td><button class="editar btn btn-warning mr-sm-2"><i class="far fa-edit"></i></button><button class="excluir btn btn-danger"><i class="fas fa-trash-alt"></i></button></td>');
                                }
                    document.write('        </tr>');
                            }
                    document.write('    </tbody>');
